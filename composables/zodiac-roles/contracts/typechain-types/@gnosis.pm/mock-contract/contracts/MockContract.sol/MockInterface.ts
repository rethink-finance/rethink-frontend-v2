...
export interface MockInterfaceInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "givenAnyReturn"
...
export interface MockInterface extends BaseContract {
  connect(runner?: ContractRunner | null): MockInterface;
  attach(target: string | Addressable): MockInterface;

import we from"./BJ6nawwT.js";import{j as Ee,M as Ce,l as Be,P as Fe,s as H,t as De,cs as U,es as ye,et as x,em as Te,y as Ve,z as Ie,u as j,eu as Re,ev as xe,ew as qe,k as Ae}from"./C5L5qVLz.js";import{q as J,m as Ge,G as We,Z as _e,N as Me,C as V,t as Oe,f as P,u as W,g as M,v as $e,k as O,R as Le,w as $,e as R}from"./xQwY3c28.js";import{u as ke}from"./BXiuiRsB.js";const lt=Ee({__name:"ProposalStateChip",props:{value:{type:String,default:""}},setup(e){const t=e,a=Ce(()=>{var o;return`proposal_state_${((o=t.value)==null?void 0:o.toLowerCase())??"undefined"}`});return(o,r)=>{const n=we;return De(),Be(n,{value:e.value,class:Fe(H(a)),uppercase:"",bold:""},null,8,["value","class"])}}}),He=J`

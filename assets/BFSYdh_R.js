import Ee from"./CbK5CNWs.js";import{d as Ce,h as Fe,c as Be,F as De,e as U,o as Te,cl as H,ey as ye,et as Ve,k as Re,t as xe,P as j,O as Ie,ez as Ae,eA as qe,eB as Ge,eC as fe,u as _e,cm as We}from"./BHCraUS5.js";import{z as Oe,G as $e,Z as Me,N as Le,u as G,R as Ue,B as $,s as q,k as ke}from"./0bL6s55-.js";import{g as z}from"./11Gq6yz9.js";import{w as R,C as V,x as He,d as N,y as je,r as M}from"./PEYYJrjd.js";import{u as J}from"./Dj0g2Xsw.js";const gt=Ce({__name:"ProposalStateChip",props:{value:{type:String,default:""}},setup(e){const t=e,s=Fe(()=>{var o;return`proposal_state_${((o=t.value)==null?void 0:o.toLowerCase())??"undefined"}`});return(o,a)=>{const r=Ee;return Te(),Be(r,{value:e.value,class:De(U(s)),uppercase:"",bold:""},null,8,["value","class"])}}}),ze=z`

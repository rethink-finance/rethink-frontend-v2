import Ee from"./BK_mGuCL.js";import{d as Ce,g as Fe,c as Be,E as De,b as U,o as Te,cl as H,et as ye,eo as Ve,k as Re,t as xe,O as j,N as Ie,eu as qe,ev as Ae,ew as Ge,ex as fe,u as _e,cm as We}from"./dtvHnkFv.js";import{z as Oe,G as $e,Z as Me,N as Le,u as G,R as Ue,B as $,s as A,k as ke}from"./BKLzUVBI.js";import{g as z}from"./y10dxvb8.js";import{v as R,C as V,w as He,d as N,x as je,r as M}from"./n2wH3nr4.js";import{u as J}from"./DA5QrANU.js";const gt=Ce({__name:"ProposalStateChip",props:{value:{type:String,default:""}},setup(e){const t=e,s=Fe(()=>{var o;return`proposal_state_${((o=t.value)==null?void 0:o.toLowerCase())??"undefined"}`});return(o,r)=>{const a=Ee;return Te(),Be(a,{value:e.value,class:De(U(s)),uppercase:"",bold:""},null,8,["value","class"])}}}),ze=z`

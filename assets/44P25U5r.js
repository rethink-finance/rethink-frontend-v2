import Ee from"./D_xxw8z9.js";import{d as Fe,D as Be,e as Ce,F as De,h as U,o as ye,cq as H,eN as Te,eO as R,eF as Ve,eP as V,eQ as Ie,d9 as P,l as Re,t as xe,u as j,ec as qe,eR as Ae,eS as Ge,ed as M,eT as We,eU as _e,eV as ve,b as Oe,cr as Me}from"./BfGjLsXf.js";import{w as $e,G as Le,Z as Ue,N as He,u as W,R as je,x as $,s as G,g as fe}from"./BOAbmo7E.js";import{g as Q}from"./BQ8DYF2E.js";import{u as Ne}from"./K3s0A6mg.js";const pt=Fe({__name:"ProposalStateChip",props:{value:{type:String,default:""}},setup(e){const t=e,a=Be(()=>{var o;return`proposal_state_${((o=t.value)==null?void 0:o.toLowerCase())??"undefined"}`});return(o,r)=>{const n=Ee;return ye(),Ce(n,{value:e.value,class:De(U(a)),uppercase:"",bold:""},null,8,["value","class"])}}}),Qe=Q`

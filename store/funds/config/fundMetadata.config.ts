...
export const fundMetaDataHardcoded = {
  ...
  [ChainId.POLYGON]: [
    ...
    },
    {
      ...
      subtitle: "BTC, ETH, stables and gold. Growth, yield, and resilience in one portfolio.",
    },
    {
  ...
  [ChainId.BASE]: [
    {
      ...
      subtitle: "Volatility-driven rebalancing with sustained exposure to ETH appreciation.",
    },
  ],
  // Arbitrum One
  [ChainId.ARBITRUM]: [
    {
      ...
      subtitle: "Adaptive perps strategy built to survive chop and thrive in runs.",
    },
    {

...
export class InitSchema1750776674425 implements MigrationInterface {
  name = "InitSchema1750776674425"

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query("CREATE TABLE \"nav_method_value\" (\"id\" SERIAL NOT NULL, \"fundAddress\" character varying NOT NULL, \"fundChainId\" character varying NOT NULL, \"navUpdateId\" integer NOT NULL, \"navUpdateIndex\" integer NOT NULL, \"navMethodId\" integer NOT NULL, \"totalNavSnapshotId\" integer, \"detailsHash\" character varying(66), \"simulatedNav\" numeric(78,0) NOT NULL, \"simulatedNavFormatted\" character varying NOT NULL, \"calculatedAt\" TIMESTAMP, \"createdAt\" TIMESTAMP NOT NULL DEFAULT now(), \"updatedAt\" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT \"PK_5fde8074ddcc679e8e9c6f6af5e\" PRIMARY KEY (\"id\"))");
    ...
    await queryRunner.query("CREATE TABLE \"total_nav_snapshot\" (\"id\" SERIAL NOT NULL, \"fundAddress\" character varying NOT NULL, \"fundChainId\" character varying NOT NULL, \"navUpdateId\" integer NOT NULL, \"navUpdateIndex\" integer NOT NULL, \"totalSimulatedNav\" character varying NOT NULL, \"totalSimulatedNavFormatted\" character varying NOT NULL, \"calculatedAt\" TIMESTAMP, \"createdAt\" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT \"PK_ad8c93ce18fe369f4f9cd3b3c55\" PRIMARY KEY (\"id\"))");
